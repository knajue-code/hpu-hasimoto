...
footer='<footer><div class="footer-inner"><a class="footer-brand" href="/">HPU &amp; Hashimoto Mentoring</a><nav>'+''.join('<a href="'+p+'">'+t+'</a>' for t,p in [('Impressum','/impressum'),('Datenschutzerklärung','/datenschutz'),('Medizinischer Disclaimer','/disclaimer')])+'</nav><div><a href="mailto:rieke@hpu-hashimoto.de">rieke@hpu-hashimoto.de</a><a href="https://www.instagram.com/hpu.hashimoto/" target="_blank" rel="noopener">Instagram</a><a href="https://www.facebook.com/groups/1100019981541003/" target="_blank" rel="noopener noreferrer">Facebook-Gruppe</a></div></div></footer>'
